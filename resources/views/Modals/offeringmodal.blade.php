<!--Add Modal -->
  <div class="modal fade" id="modal-offering" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ url('addOffering') }}" enctype="multipart/form-data" id="addOffering">
...
o
<!--Edit Modal -->
  <div class="modal fade" id="modal-editoffering" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          	<form method="POST" action="{{ url('offering') }}" enctype="multipart/form-data" id="updateOffering">
